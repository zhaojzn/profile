    ...
    return (
        <div>
            {state ? (
                ...
                <div className="justify-between items-center rounded bg-neutral-800 flex w-[280px] max-w-full flex-col mt-5 px-5 py-5">
                ...
                <div className="text-white text-base ml-6 mt-10 max-md:ml-2.5">
                    <button onClick={() => props.change(props.company)} >{props.company}</button>
                </div>
